...
$string = "Hello, I am Mukul"; // Extract SamiurRahmanMukul into variable
$string2 = 'Hello, I am SamiurRahmanMukul'; // Replace SamiurRahmanMukul with variable
echo $string . '<br>';
echo $string2 . '<br>';
