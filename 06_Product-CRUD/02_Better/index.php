...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <div class="controller">
        <a href="./pages/create.php" class="btn btn-lg btn-success">Create New Product</a>
      </div>
  ...
  "title"
            ...
            <td>
              <!-- // !update button -->
              <a href="./pages/update.php?id=<?php echo $product[
                "id"
              ]; ?>" type="button" class="btn btn-sm btn-outline-primary">Edit</a>
              
              <!-- // !delete button -->
              <form style="display: inline-block;" action="./pages/delete.php" method="post">
